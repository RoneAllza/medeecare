...
<div class="container">
    <h2>Tabel Hasil Tes Depresi Kamu :</h2>
    <a href="{{ route('tes-depresi.index') }}" class="btn btn-info">Ambil Tes Lagi</a> <!-- Tombol Ambil Tes Lagi -->
    <h2>     </h2>
    <table class="table">
        <thead>
            <tr>
            ...
            @foreach ($hasilTes as $hasil)
                <tr>
                    ...
                    <td class="action-column">
                        <a href="{{ route('hasil-tes-depresi.show', $hasil->id) }}" class="btn btn-info">Lihat Detail</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
